...
import AdminBarEditPage from "./pages/admin/AdminBarEditPage";
import AdminManageDrinkMenuPage from "./pages/admin/AdminManageDrinkMenuPage";
      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute roleRequired="admin" />}>
          <Route path="/admin" element={<AdminDashboardLayout />}>
            ...
            <Route path="bars/:barId/edit" element={<AdminBarEditPage />} />
            <Route path="bars/:barId/menu" element={<AdminManageDrinkMenuPage />} />
